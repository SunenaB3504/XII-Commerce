...
import { challengeQuestions17to22_2024 } from './business-studies-challenge-2024-q17-22.ts';
import { challengeQuestions23to26_2024 } from './business-studies-challenge-2024-q23-26.ts';
import { challengeQuestions27to34_2024 } from './business-studies-challenge-2024-q27-34.ts';

export const businessStudiesChallenge2024: ChallengePaper = {
  ...
  questions: [
    // Questions 1-16: 1-mark MCQs (inline in main file for simplicity)
    {
      ...
      question: React.createElement(React.Fragment, null,
        ...
        React.createElement("p", { className: "mt-2" }, "The nature of management being highlighted in the above case is:"),
        React.createElement("ul", { className: "list-none pl-6 mt-4 space-y-2" },
          React.createElement("li", null, "a) Management as science"),
          React.createElement("li", null, "b) Management as profession"),
          React.createElement("li", null, "c) Management as art"),
          React.createElement("li", null, "d) Both A. and C.")
        )
      ),
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "a) Management as science"),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "Management as science is highlighted as the manager conducted an experiment to observe the effect of improved physical conditions on worker performance, similar to scientific methods.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "d) Assignment of duties"),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "Assignment of duties involves allocating specific tasks to individuals based on their skills and competencies. In the previous season, work was not properly assigned, leading to problems.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "c) Both Assertion (A) and Reason (R) are true, but Reason (R) is not the correct explanation of the Assertion."),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "Financial planning helps tackle uncertainty about funds availability and timing. Capital structure refers to the mix of owners' and borrowed funds, but this doesn't directly explain financial planning.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "Statement II is correct as capital market deals in medium and long-term securities. Statement I is incorrect as primary market directly promotes capital formation, not secondary market.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "a) Competitive spirit among the existing staff"),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "External recruitment brings in new talent, creating competition among existing staff to perform better and maintain their positions.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "d) Economic and technological environment"),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "Easy finance facilities represent economic environment, and new branch management software represents technological environment.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "c) Buy only standardised products"),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "Looking for quality marks like FPO or hallmark ensures that consumers buy only standardized products that meet quality standards.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "d) Assertion(A) is false, Reason(R) is true."),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "Controlling cannot prevent deviations as they occur during operations. However, it helps minimize future deviations by taking corrective actions.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "c) Training and development, performance appraisal, promotion and career planning, compensation"),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "The correct sequence of staffing steps after selection is: Training and development, Performance appraisal, Promotion and career planning, Compensation.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "b) controlling helps in ensuring order and discipline"),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "Using biometric and retina scanning ensures security and maintains order and discipline in the organization by controlling access to premises.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "d) Size of the assets, Profitability and competitiveness are not affected by capital budgeting decisions."),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "Capital budgeting decisions significantly affect the size of assets, profitability, and competitiveness of the organization as they involve long-term investment decisions.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "d) More than ₹1 crore and not more than ₹10 crore"),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "State Commission has jurisdiction over complaints where the value of goods and services is more than ₹1 crore but not more than ₹10 crore.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "a) (a)-(iii), (b)-(ii), (c)-(i), (d)-(iv)"),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "(a) Regional demand differences show relativity, (b) Fast technological changes show dynamic nature, (c) Difficulty in prediction shows uncertainty, (d) Government changes affecting multiple factors shows interrelatedness.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "c) Grading"),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "Grading is the process of classification of products into different groups based on characteristics like quality, size, etc.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "c) Induction training"),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "Induction training is provided to new employees on their first day to familiarize them with the organization, its policies, procedures, and work environment.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    },
    {
      ...
      solution: React.createElement("p", { className: "font-bold text-green-700" }, "d) The provisions of Consumer Protection Act came into force from 1981."),
      explanation: React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "font-bold text-lg mt-4" }, "Explanation"),
        React.createElement("p", null, "The Consumer Protection Act, 1986 came into force from 1st July 1987, not 1981.")
      ),
      challengeData: {
        year: 2024,
        paperType: 'main',
    ...
    ...challengeQuestions17to22_2024,
    ...challengeQuestions23to26_2024,
    ...challengeQuestions27to34_2024
  ]
};