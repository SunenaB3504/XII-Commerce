...
export const questions1to10: Question[] = [
    ...
    },
    {
        ...
        explanation: React.createElement(React.Fragment, null,
            ...
            React.createElement("p", null, "2. Since profits were only 84,000, we have insufficient profits. As IoC is an appropriation, it is provided only to the extent of profits in the ratio of capital (5:4:3)."),
            React.createElement("p", null, "Actually, the question says 'distributed without providing'. This implies we need to reverse the wrong distribution and provide correctly."),
            React.createElement("p", null, "Wait, typically if profit < IoC, we distribute available profit in Capital Ratio. Capital Ratio = 5:4:3."),
            React.createElement("p", null, "Profit distributed wrongly = 84,000 in 2:2:1."),
            React.createElement("p", null, "Profit to be distributed correctly (as IoC equivalent) = 84,000 in 5:4:3."),
            React.createElement("p", null, "Teeka's Wrong Credit = 84,000 × 1/5 = 16,800."),
            React.createElement("p", null, "Teeka's Correct Credit (as IoC share) = 84,000 × 3/12 = 21,000."),
