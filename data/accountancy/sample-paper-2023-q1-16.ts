...
// NOTE: Content for this batch should be populated from RawContent/Accountancy/Accountancy-SQP-2023-extracted.txt
const paper: QuestionPaper = {
  name: 'Sample Paper 2023 Questions 1-16',
  questions: [
    {
      id: '1',
      marks: 1,
    ...
    },
    {
      ...
      solution: React.createElement('p', { className: 'font-bold text-green-700' }, 'Answer: c'),
      explanation: React.createElement('p', null, 'MS: goodwill = ₹2,40,000 for this scenario.')
    },
    {
      id: '9',
      marks: 1,
    ...
    },
    {
      ...
      question: React.createElement(React.Fragment, null,
        ...
        React.createElement('ul', { className: 'list-none pl-6 mt-2' },
          React.createElement('li', null, 'A. PK Ltd. Dr. To Share Capital A/c To Securities Premium A/c To Bank A/c To Statement of P&L (Being settlement of amount due to vendors) 20,00,000 ...'),
          React.createElement('li', null, 'B. PK Ltd. Dr. To Share Capital A/c To Securities Premium A/c To Bank A/c (Being settlement of amount due to vendors) 20,00,000 ...'),
          React.createElement('li', null, 'C. PK Ltd. Dr. To Share Capital A/c To Securities Premium A/c To Bank A/c (Being settlement of amount due to vendors) 20,00,000 ...'),
          React.createElement('li', null, 'D. PK Ltd. Dr. To Share Capital A/c To Securities Premium A/c To Bank A/c (Being settlement of amount due to vendors) 20,00,000 ...')
        )
      ),
      solution: React.createElement('p', { className: 'font-bold text-green-700' }, 'Answer: B'),
      explanation: React.createElement('p', null, 'MS indicates option B with the specific ledger entries shown in the scheme.')
    },
    {
      id: '13',
      marks: 1,
