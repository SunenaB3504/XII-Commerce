...
export const questions1to10: Question[] = [
    ...
    },
    {
        ...
        explanation: React.createElement('div', null,
            ...
            'See Q10 solution for detailed calculation.',
            React.createElement('br'),
            'Divisible Profit = 34,900.',
            React.createElement('br'),
            'Richa\'s Share = 34,900 × 3/5 = 20,940.'
        )
    },
    {
        ...
        explanation: React.createElement('div', null,
            ...
            'Profit "after charging Anmol’s salary" but "prior to interest" = 62,000.',
            React.createElement('br'),
            'Add back Salary to get Net Profit before appropriations = 62,000 + 12,500 = 74,500.',
            React.createElement('br'),
            'Manager Commission = 5% of 62,000 (as per text "5% of THIS profit") = 3,100.',
            React.createElement('br'),
            'Wait, "5% of THIS profit" refers to 62,000. So Managers Commission = 3,100.',
            React.createElement('br'),
            'Net Profit transferred to P&L Appr (after manager commission) = 74,500 - 3,100 = 71,400.',
            React.createElement('br'),
            'Check: 62000 - 3100 + 12500? No. Profit before salary = 74500. Commission = 3100. Profit after commission = 71,400.'
        )
    }
];
