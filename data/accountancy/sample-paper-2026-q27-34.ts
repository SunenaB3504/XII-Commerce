...
export const questions27to34: Question[] = [
  {
    ...
    explanation: React.createElement(React.Fragment, null,
      React.createElement("p", { className: "mt-2" }, "Change in Inventories = Opening Inventory - Closing Inventory (excluding Raw Material)"),
      React.createElement("ul", { className: "list-disc pl-6 mt-2" },
        React.createElement("li", null, "Note: Raw Material is part of 'Cost of Materials Consumed', not 'Change in Inventories'."),
        React.createElement("li", null, "Components: Work in Progress + Finished Goods + Stock in Trade"),
        React.createElement("li", null, "Opening (2024): ₹1,40,000 + ₹1,00,000 + ₹1,20,000 = ₹3,60,000"),
        React.createElement("li", null, "Closing (2025): ₹1,00,000 + ₹70,000 + ₹2,00,000 = ₹3,70,000"),
        React.createElement("li", null, "Change = ₹3,60,000 - ₹3,70,000 = ₹(10,000)")
      ),
