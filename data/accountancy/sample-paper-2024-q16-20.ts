...
export const questions16to20: Question[] = [
    {
        ...
        explanation: React.createElement('div', null,
            ...
            React.createElement('br'),
            'Alternatively: Amount Realised = Book Value of Assets - Loss + Liabilities (if not paid? No, let\'s use Cash Account approach or Realisation A/c structure).',
            React.createElement('br'),
            'Realisation A/c:',
            React.createElement('br'),
            'Dr: Sundry Assets (1,70,000) + Cash Paid for Liab (35,000 assumed if not given) + Exp (5,000) = 2,10,000.',
            React.createElement('br'),
    ...
    },
    {
        ...
        solution: React.createElement('div', null,
                ...
                React.createElement('table', { className: 'min-w-full border border-gray-300 text-sm' },
                    ...
                    React.createElement('tbody', null,
                        React.createElement('tr', null,
                            ...
                            React.createElement('td', { className: 'border p-2' }, '11,648 (Dr) (Wait, calc needs check)')
                        ),
                        React.createElement('tr', null,
            ...
            React.createElement('p', { className: 'mb-4 italic' }, '*Note: The exact distribution of net effect involves sharing the total error amount in profit sharing ratio. Total Dr = 1,920 (IOC) + 12,000 (Sal) = 13,920. Total Cr = 12,000. Net Difference 1,920 is profit to be credited? No, let\'s look at MS.'),
            React.createElement('div', { className: 'overflow-x-auto mb-4' },
                React.createElement('table', { className: 'min-w-full border border-gray-300 text-sm' },
                    React.createElement('thead', null,
                        React.createElement('tr', { className: 'bg-gray-100' },
    ...
    },
    {
        ...
        explanation: React.createElement('div', null,
            ...
            React.createElement('br'),
            'Called up = 8. Unpaid: Allotment (2+1 prem) = 3, First Call = 2. Total Unpaid (excluding premium) = 2 + 2 = 4.',
            React.createElement('br'),
            'Paid = Called (8) - Unpaid including prem (5) ? No. Called up includes premium? usually "₹8 called up" implies capital called up. Let\'s check.',
            React.createElement('br'),
            'Face Value 10. Issued at 1 prem. Called up 8.',
            React.createElement('br'),
            'Unpaid: Allotment 3 (2 cap + 1 prem), First Call 2.',
            React.createElement('br'),
            'Paid = Called (8) - Unpaid Capital (4) = 4. Wait. If he didn\'t pay allotment, he didn\'t pay premium. Premium not received is debited. Amount forfeited is only CAPITAL portion received.',
            React.createElement('br'),
            'Received: Application only. If Allotment is 2+1 and First Call is 2, and total called is 8. App = 8 - 2 - 2 = 4.',
            React.createElement('br'),
            'So Amt Forfeited = 100 * 4 = 400. This matches Credit side.',
            React.createElement('br'),
            'Reissue to Ram (60 shares): Fully paid for 8. Discount = 10 - 8 = 2. Loss = 60 * 2 = 120.',
            React.createElement('br'),
            'Gain Ram = 60 * (4 forfeited - 2 loss) = 120.',
            React.createElement('br'),
            'Reissue to Suraj (20 shares): Fully paid @ 12. Premium Reissue. No discount.',
            React.createElement('br'),
            'Gain Suraj = 20 * (4 forfeited - 0 loss) = 80.',
            React.createElement('br'),
            'Balance c/d = Rem 20 shares * 4 = 80.'
        )
    },
    {
